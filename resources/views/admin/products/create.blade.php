...
<head>
    ...
    <title>Tambah Produk Baru - Rattan Handmade Admin</title>
...
<body>
    ...
    <main class="main-content">
        <header class="navbar">
            <div class="breadcrumb">Sistem Utama / Kelola Produk / <span>Tambah Baru</span></div>
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" placeholder="Contoh: Rak Sepatu Jati Minimalis" value="{{ old('name') }}" required>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <input type="number" id="stock" name="stock" class="form-control" placeholder="0" min="0" value="{{ old('stock', 1) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control" placeholder="Jelaskan detail ukuran, material kayu yang digunakan, dan keunggulan produk di sini...">{{ old('description') }}</textarea>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-submit">Simpan ke Etalase</button>
                    </div>
                </form>
            </div>
