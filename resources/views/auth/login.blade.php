...
<head>
    ...
    <title>Masuk Pelanggan - Rattan Handmade</title>
    ...
    <style>
        * { box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        body { 
            ...
            padding: 20px;
            /* Tambahan aksen latar belakang halus */
        ...
        .forgot-link:hover { color: #724a23; text-decoration: underline; }
...
<body>
    ...
    <div class="login-card">
        <div class="card-header">
            ...
            <div class="header-subtitle">Silakan masuk untuk melanjutkan belanja</div>
        </div>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="email@contoh.com" required autofocus autocomplete="username">
                </div>
